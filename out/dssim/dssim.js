...
export class DssimResult {
    ...
    get heatmap() {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.dssimresult_heatmap(ptr);
     ...
     */
    get score() {
        const ret = wasm.dssimresult_score(this.__wbg_ptr);
        return ret;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('dssim_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
