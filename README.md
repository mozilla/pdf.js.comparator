...
| `pdfium.yml`      | `pdfium`, `abseil`, `fast_float`, `dragonbox` all track HEAD (`PDFIUM_REF=main`) |
| `mupdf.yml`       | pinned at `1.26.1` — newer mupdf forces wasm-EH that breaks our runtime          |
